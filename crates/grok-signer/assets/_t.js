...
// 用法: 替换 testmeta / /rest/app-chat/conversations/new / POST 后 node 执行；结果写 globalThis.__signOut
...
const grMeta = [{ name: 'grok-site-verification', content: 'testmeta', getAttribute: (n) => (String(n) === 'content' ? 'testmeta' : null), childNodes: [], parentElement: null, nodeType: 1 }];
...
globalThis.__signOut = signer('/rest/app-chat/conversations/new', 'POST');
